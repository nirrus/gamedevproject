...
var hostport = 2000; //Define which port the server will use
var hostfps = 60; 	 //Define the target FPS
...
serv.listen(process.env.PORT || hostport);
console.log("Server started. Press Ctrl+C at any time to shutdown.");
